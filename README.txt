...
Με την κάτω μπάρα μπορεί να πάει στο search, στο οποίο μπορεί να αναζητήσει στόχους και tasks, και στο shop, στο οποίο μπορεί να αγοράσει πράγματα. 
...
Γ) Η εφαρμογή κατέληξε αρκετά διαφορετική από αυτή της Β φάσης οπτικά, καθώς χρησιμοποιήθηκε διαφορετικό UI. Παρόλα αυτά, η πλειονότητα της λειτουργικότητας έχει διατηρηθεί.
